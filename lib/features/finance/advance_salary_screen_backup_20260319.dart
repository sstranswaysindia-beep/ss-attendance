...
class _AdvanceSalaryScreenState extends State<AdvanceSalaryScreen> {
  ...
  Widget _iconBadge(IconData icon, {Color? bg, Color? fg}) {
    return Container(
      ...
      child: Icon(icon, color: fg ?? Colors.white, size: 22),
    );
  }
  ...
  Widget _buildProfileSection() {
    ...
    final heroGradient = _heroVehicleIsOngoing
        ...
        : const LinearGradient(
            colors: [_khataPrimary, _khataPrimary2, Color(0xFF0D4F6B)],
            begin: Alignment.topLeft,
            end: Alignment.bottomRight,
          );
    final textColor = _heroVehicleIsOngoing
        ? Colors.black.withOpacity(0.85)
        : Colors.white;
    final subtleTextColor = _heroVehicleIsOngoing
        ? Colors.black.withOpacity(0.68)
        : Colors.white.withOpacity(0.7);
    final chipBackground = _heroVehicleIsOngoing
        ? Colors.black.withOpacity(0.08)
        : Colors.white.withOpacity(0.14);
    final chipBorder = _heroVehicleIsOngoing
        ? Colors.black.withOpacity(0.14)
        : Colors.white.withOpacity(0.18);
    final heroBorder = _heroVehicleIsOngoing
        ? Colors.black.withOpacity(0.10)
        : Colors.white.withOpacity(0.18);
    final heroShadowColor = _heroVehicleIsOngoing
        ? const Color(0xFFD4A017).withOpacity(0.28)
        : _khataPrimary.withOpacity(0.35);
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    ...
                    style: OutlinedButton.styleFrom(
                      foregroundColor: const Color(0xFF1A4A7A),
  ...
  Widget _buildTransactionHistory() {
    ...
    return Column(
      ...
      children: [
        _sectionHeader(
          'Transaction History',
          subtitle: 'Grouped by date • Tap receipt icon to view',
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          Container(height: 1, width: 72, color: const Color(0xFFE7ECF3)),
        ],
      ),
    );
  }
