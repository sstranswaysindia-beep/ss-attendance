...
class _AdvanceSalaryScreenState extends State<AdvanceSalaryScreen> {
        ...
        child: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              colors: [Color(0xFF0D2137), Color(0xFF1A4A7A)],
  ...
  Widget _buildProfileSection() {
    ...
    final subtleTextColor = const Color(0xFF212121).withOpacity(0.6);

    // Card gradient: green for positive, red for negative
    final gradientColors = isPositive
        ? const [Color(0xFFC8EE88), Color(0xFFD8F999)]
        : const [Color(0xFFFFBBC4), Color(0xFFFFCCD3)];
    final shadowColor = isPositive
        ? const Color(0xFFD8F999)
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFF1A4A7A).withOpacity(0.08),
                  borderRadius: BorderRadius.circular(8),
                ),
                child: Text(
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          Container(height: 1, width: 60, color: Colors.grey.shade200),
        ],
      ),
    );
  }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == 'ok') {
          ...
          const _hideExactNormalized = <String>[
            'safety',
          ];
