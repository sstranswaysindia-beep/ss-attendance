          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                subtitle: const Text('Earn by referring drivers'),
                onTap: () {
                  Navigator.of(context).pop();
              ...
              ListTile(
                ...
                trailing: Icon(
                  _biometricEnabled ? Icons.check_circle : Icons.chevron_right,
                  color: _biometricEnabled ? Colors.green : null,
                ),
                onTap: () {
                  Navigator.of(context).pop();
          ...
          child: Padding(
            ...
            child: ListView(
              children: [
                  ...
                  children: [
                    if (tenureSubtitle != null) ...[
                      Chip(
                        ...
                        backgroundColor: const Color(0xFF9AE630),
                ...
                Card(
                  ...
                  child: Column(
                    children: [
                      ...
                      HoverListTile(
                        leading: const Icon(Icons.card_giftcard_rounded),
                        title: const Text('Refer a Driver - Earn'),
                        onTap: () => _openScreen(
                ...
                const SizedBox(height: 16),
                // ── Current Month Trips Section (always shown for drivers) ──
                _buildCurrentMonthTripsSection(theme, textTheme),
                const SizedBox(height: 16),
                Text(
                  'Plant & Vehicle',
                  style: Theme.of(context).textTheme.titleMedium,
