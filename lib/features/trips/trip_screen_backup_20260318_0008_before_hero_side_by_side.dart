...
class _TripScreenState extends State<TripScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    const heroBaseHeight = 280.0;
    const heroCardOverlap = 40.0;
      ...
      child: Scaffold(
        ...
        body: DecoratedBox(
          ...
          child: RefreshIndicator(
            ...
            child: Stack(
              children: [
                // Hero header background behind the AppBar.
                Positioned(
                  left: 0,
                  right: 0,
                  top: 0,
                  child: _SectionReveal(
                    child: _HeroHeader(
                      ...
                      vehicleNo: _selectedVehicle?.number ?? 'Select vehicle',
                      monthLabel: '${_selectedStartDate.year}-${_selectedStartDate.month.toString().padLeft(2, '0')}',
                ...
                Positioned.fill(
                  child: ListView(
                    padding: EdgeInsets.only(
                      left: 16,
                      right: 16,
                      top: (heroTotalHeight - heroCardOverlap).clamp(0, 9999),
                    ...
                    children: [
                      ...
                      if (_isLoading && overview == null)
                        ...
                        _SectionReveal(
                          ...
                          child: _SummarySection(summary: overview.summary),
                        ),
                        const SizedBox(height: 12),
                        _SectionReveal(
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          Padding(
            padding: EdgeInsets.fromLTRB(16, top + 32, 16, 14),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Row(
